 ...
 * Generated at: 2018-11-21 14:58:31 UTC
...
public final class product_005finfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t//获得购买的商品的数量 //.val返回或设置被选元素的值\r\n");
      ...
      out.write("\t\t\t\t\t\t\t购买数量: \r\n");
      out.write("\t\t\t\t\t\t\t<input id=\"buyNum\" name=\"buyNum\" value=\"1\" maxlength=\"4\" size=\"10\" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<!--  点击商品和文字之后会触发addCart的事件\r\n");
      out.write("\t\t\t\t\t\t\t调用ProductServlet之后会重定向到购物车之中\r\n");
      out.write("\t\t\t\t\t\t\t商品的id值是固定的会在获取此商品的底层中传递过来的product中已经得知pid\r\n");
      out.write("\t\t\t\t\t\t\t但是购买数量是不确定的 所以在上面需要使用jquery的方法将值动态传递给后端\r\n");
      out.write("\t\t\t\t\t\t\t这些事servlet容器帮忙完成的\r\n");
      out.write("\t\t\t\t\t\t-->\r\n");
      out.write("\t\t\t\t\t\t<div style=\"margin: 20px 0 10px 0;; text-align: center;\">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"javascript:void(0);\" onclick=\"addCart()\">\r\n");
      out.write("\t\t\t\t\t\t\t <input style=\"background: url('./images/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0); height: 36px; width: 127px;\"\r\n");
